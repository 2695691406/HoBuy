...
<body
	style="background-image: url('/HoBuy/jsp/img/maoboli.jpg'); background-size: cover;">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4 ">
				<c:if test="${sessionScope.user==null }">
					<form action="/HoBuy/solerworker/login.do" id="demoForm" method="post">
						<div class="form-group">
							<label for="username">用户账户</label> <input name="id"
								type="text" class="form-control" id="username" placeholder="编号"
								value="${user.phone }">
						</div>
						<div class="form-group">
							<label for="password">密码</label> <input name="account"
