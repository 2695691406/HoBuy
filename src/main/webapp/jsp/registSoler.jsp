				...
				<form action="/HoBuy/registsoler.do" method="post">
					<div id="namediv" class="form-group">
						<input name="name" type="text" class="form-control" id="name"
							placeholder="姓名" value="${soler.name }">
						<h6>
					...
					<div id="emaildiv" class="form-group">
						...
						<input name="email" type="email" class="form-control" id="email"
							placeholder="邮箱" value="${soler.email }">
						<h6>
					...
					<div id="pwddiv" class="form-group">
						<input id="pwd" name="pwd" type="password" class="form-control"
							placeholder="密码">
						<h6>
							<span id="pwdmsg" class="label label-success">8-30位需要包含大写字母小写字母特殊符号</span>
						</h6>
					</div>
					...
					<div class="form-group">
						...
						<h6>
							<span class="label label-danger">${addressmsg }</span>
						</h6>
					</div>
					<div class="form-group">
						...
						<h6>
							<span class="label label-danger">${introducemsg }</span>
						</h6>
					</div>
					...
					<div class="checkbox" align="center">
						<label> <input id="arrage" type="checkbox" name="arrage"
							value="1"> 我同意HoBuy网站商家使用协议
						</label>
						<h6>
							<span id="arragemsg" class="label label-danger">${solerarragemsg }</span>
						</h6>
					</div>
					<div class="form-group">
