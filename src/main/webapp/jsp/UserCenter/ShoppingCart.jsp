	...
	<div class="container" style="min-height: 500px;"
		...
		<c:if test="${shoppingcarts[0]!=null }">
			<form action="/HoBuy/usercenter/orders.do" method="post">
						...
						<div class="panel-body">
							<div class="bs-example " data-example-id="default-media"
								...
								<div class="media " style="">
									...
									<div class="media-left">
										<a href="/HoBuy/product.do?id=${Cart.repertory.product.id }">
											<img class="media-object" src="${Cart.repertory.imgurl }"
				...
				<div class="panel panel-default">
					<div class="panel-body form-inline">
						<input type="radio" name="id" value="-1"> 姓名：<input
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<input type="submit" class="btn btn-primary btn-sm" value="结算">
					</div>
				</div>
			</form>
		</c:if>
