	...
	<form class="form-horizontal">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li class="nav-item"><a class="nav-link" href="#new-1"
				onclick="change('sending_i')" role="tab" data-toggle="tab">已发货订单</a></li>
			<li class="nav-item"><a class="nav-link" href="#new-1"
				onclick="change('success_i')" role="tab" data-toggle="tab">已收货订单</a></li>
			<li class="nav-item"><a class="nav-link" href="#new-1"
				onclick="change('evaluate_i')" role="tab" data-toggle="tab">未评价订单</a></li>
			<li class="nav-item"><a class="nav-link" href="#new-1"
				onclick="change('over_i')" role="tab" data-toggle="tab">已完成订单</a></li>
			<li class="nav-item"><a class="nav-link" href="#new-1"
				onclick="change('wantCancale_i')" role="tab" data-toggle="tab">申请取消订单</a></li>
			<li class="nav-item"><a class="nav-link" href="#new-1"
				onclick="change('solerCancale_i')" role="tab" data-toggle="tab">商家取消订单</a></li>
			<li class="nav-item"><a class="nav-link" href="#new-1"
				onclick="change('userCancale_i')" role="tab" data-toggle="tab">用户取消订单</a></li>
		</ul>
		<!-- Tab panes -->
