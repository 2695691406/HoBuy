...
<body>
	...
	<div class="container">
			...
			<div class="card-block">
				<blockquote class="card-blockquote">
					<div class="card card-block">
						<h3 class="card-title">服饰</h3>
						<p class="card-text">穿、看、听、你的世界你感受</p>
		...
		<div class="row">
			...
			<c:forEach items="${clothes }" var="clo">
				<div class="col-sm-3">
					<a href="/HoBuy/ProductServlet?method=showDetals&id=${clo.id }">
						<div class="card">
							<img src="${clo.img }" class="img-responsive"
		...
		<div class="row">
			<c:forEach items="${phones }" var="phone">
				<div class="col-sm-3">
					<div class="card">
						<div class="card-block">
							<h6 class="card-subtitle text-muted">${phone.name }</h6>
						</div>
						<a href="/HoBuy/ProductServlet?method=showDetals&id=${phone.id }">
							<img src="${phone.img }" class="img-responsive"
							alt="Responsive image">
						</a>
						<div class="card-block">
							<p class="card-text">
								<a
									href="/HoBuy/ProductServlet?method=showDetals&id=${phone.id }">
									${phone.subtitle } </a>
							</p>
							<a href="#" class="card-link">${phone.price }</a> <a href="#"
								class="card-link">去看看</a>
						</div>
					</div>
				</div>
			</c:forEach>
				...
				<div class="col-sm-3">
					<div class="card">
						<a href="/HoBuy/product.do?id=${food.id }">
							<img src="${food.imgurl }" class="img-responsive"
							alt="Responsive image">
						</a>
						<div class="card-block">
							<a href="/HoBuy/product.do?id=${food.id }">
		...
		<div class="row">
			<c:forEach items="${mZhuang }" var="mz">
				<div class="col-sm-3">
					<div class="card">
						<div class="card-header">${mz.name }</div>
						<div class="card-block">
							<blockquote class="card-blockquote">
								<a href="/HoBuy/ProductServlet?method=showDetals&id=${mz.id }">
									<p>
										<img src="${mz.img }" class="img-responsive"
											alt="Responsive image">
									</p>
								</a>
								<footer> <cite title="">${mz.price }</cite> </footer>
							</blockquote>
						</div>
					</div>
				</div>
