/***********************************************************************
 * Module:  Customerservice.java
 * Author:  ZD
 * Purpose: Defines the Class Customerservice
 ***********************************************************************/
...
public class Customerservice implements java.io.Serializable {
   ...
   public void setSoler(Soler newSoler) {
      if (this.soler == null || !this.soler.equals(newSoler))
      {
         if (this.soler != null)
         {
            ...
            this.soler = null;
            //oldSoler.removeCustomerservice(this);
         }
         if (newSoler != null)
         {
            this.soler = newSoler;
            //this.soler.addCustomerservice(this);
         }
      }
   }
   
   /**
    * Get value of customerservicePK.
    *
    * @return customerservicePK object
    */
   public CustomerservicePK getCustomerservicePK() {
      return new CustomerservicePK(id);
   }
   
   /**
    * Set value of customerservicePK.
    * 
    * @param pk
    */
   public void setCustomerservicePK(CustomerservicePK pk) {
      if (pk != null) {
         this.id = pk.getId();
      }
   }
   ...
   public String toString()
   {
      ...
      ret.append( "hobuy.domain.Customerservice: " );
      ret.append( "id='" + id + "'");
