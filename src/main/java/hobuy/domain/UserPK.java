 ...
 * Module:  UserPK.java
 * Author:  ZD
 * Purpose: Defines the priamry key class for class User
 ***********************************************************************/
...
/**
 * Generated primary key class for User. It is used to simplify the query
...
public class UserPK implements java.io.Serializable{
   ...
   public String toString()
   {
      ...
      ret.append( "hobuy.domain.UserPK: " );
      ret.append( "id='" + id + "'");
      return ret.toString();
   }
}